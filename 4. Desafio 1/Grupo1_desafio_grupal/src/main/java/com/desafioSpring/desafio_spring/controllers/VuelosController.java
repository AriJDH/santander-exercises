...
import com.desafioSpring.desafio_spring.dto.VuelosDto;
...
public class VuelosController {
    ...
    public ResponseEntity<ResponsePayloadVuelosDto> registrarClientesVuelo(@RequestBody PayloadVuelosDto clienteDto) {
