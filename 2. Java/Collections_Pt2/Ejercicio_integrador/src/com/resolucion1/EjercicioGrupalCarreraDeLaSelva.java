...
public class EjercicioGrupalCarreraDeLaSelva {
    public static void main(String[] args) {
        ...
        int categoria;
        int nroInscriptoParaEliminar;
        boolean participanteEliminado;
        ...
        recaudacionTotal(circuitoChico, circuitoMedio, circuitoAvanzado);
        System.out.println("Ingrese el numero de participante que quiera eliminar");
        nroInscriptoParaEliminar=teclado.nextInt();
        participanteEliminado=desinscribir(nroInscriptoParaEliminar, circuitoAvanzado, circuitoChico, circuitoMedio);
        if(participanteEliminado){
            System.out.println("PARTICIPANTE ELIMINADO CON EXITO");
        }
        else{
            System.out.println("NO EXISTE EL PARTICIPANTE ENVIADO");
        }
        recaudacionTotal(circuitoChico, circuitoMedio, circuitoAvanzado);
