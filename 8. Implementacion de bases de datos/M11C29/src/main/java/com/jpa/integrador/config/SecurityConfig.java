...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .regexMatchers("/api/clothes/contains?.*").permitAll()
                //.antMatchers("/api/clothes/contains?name=*").permitAll()//.hasAuthority("ROLE_MID")
                .antMatchers("/helloUser").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
                .antMatchers("/api/sale").hasAnyAuthority("ROLE_ADMIN","ROLE_MID")
                .antMatchers("/helloAdmin").hasAuthority("ROLE_ADMIN")
                .antMatchers("/api/clothes").hasAuthority("ROLE_MID")
                .antMatchers("/api/clothes/{code}").hasAuthority("ROLE_USER")
                .and()
