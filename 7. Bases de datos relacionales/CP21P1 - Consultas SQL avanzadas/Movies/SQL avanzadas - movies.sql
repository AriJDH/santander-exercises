...
FROM actors a INNER JOIN episodes e INNER JOIN actor_episode ae
ON a.id = ae.actor_id AND e.id = ae.episode_id;
...
FROM actors a INNER JOIN actor_movie am INNER JOIN movies m
